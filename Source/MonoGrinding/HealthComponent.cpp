...
void UHealthComponent::BeginPlay()
{
	...
	OwnerActor = GetOwner();
	HealthBarWidget = Cast<UWidgetComponent>(OwnerActor->GetComponentByClass(UWidgetComponent::StaticClass()));
...
void UHealthComponent::Revive()
{
	...
	USkeletalMeshComponent* MeshComp = Cast<USkeletalMeshComponent>(OwnerActor->GetComponentByClass(USkeletalMeshComponent::StaticClass()));
	if (MeshComp)
	{
